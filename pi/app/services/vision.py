...
class VisionSystem:
    ...
    def start(self):
        ...
        try:
            ...
            if not self.cap.isOpened():
                ...
                print("Hint: If on Pi Bookworm, try running with 'libcamerify' wrapper.")
                self.cap = None
            else:
    ...
    def _update_loop(self):
        while self.running:
            ...
            self.latest_frame = image # Store for streaming
    ...
    def generate_frames(self):
        while True:
            ...
            # Use the latest frame stored by _update_loop
